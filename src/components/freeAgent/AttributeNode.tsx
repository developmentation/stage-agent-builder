...
export function AttributeNode({ data }: NodeProps<FreeAgentNodeData>) {
  ...
  return (
    <div className="w-52 rounded-lg border-2 border-cyan-300 dark:border-cyan-700 bg-cyan-50/90 dark:bg-cyan-950/40 shadow-md overflow-hidden cursor-pointer hover:border-cyan-400 dark:hover:border-cyan-500 transition-colors">
